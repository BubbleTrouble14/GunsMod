...
public class GuiCrafter extends GuiContainer
{
	...
	public static final ResourceLocation texture = new ResourceLocation(Main.MODID,
			"textures/gui/crafter.png");
	private TECrafter tileEntity;
	...
	public GuiCrafter(InventoryPlayer invPlayer, TECrafter tileInventorySmithy)
	{
		super(new ContainerCrafter(invPlayer, tileInventorySmithy));
	...
	/**
	 * Called from the main game loop to update the screen. Can hide a button by
	 * setting the visible field
	 */
	@Override
	 ...
	 * renderPartialTicks Can use GL11 to set colors and such (progress of
	 * crafting item)
	 */
	@Override
	...
	public void onGuiClosed()
	{
		...
		if (((ContainerCrafter) this.inventorySlots).getNumCrafters() == 0)
		{
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		this.fontRenderer.drawString(name, (int) (xSize / 2) - (name.length() * 5 / 2), 5,
				Color.darkGray.getRGB());
		// Number being crafted
		if (tileEntity.isCraftingOne())
		{
			this.fontRenderer.drawString("Crafting one item", CRAFTING_TEXT_XPOS,
