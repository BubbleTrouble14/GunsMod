...
public class RightGunFiredClient implements IMessage
{
	public RightGunFiredClient()
	{}
	...
	public static class Handler implements IMessageHandler<RightGunFiredClient, IMessage>
	{
		@Override
		public IMessage onMessage(final RightGunFiredClient message, MessageContext ctx)
		{
		...
		static void processMessage(RightGunFiredClient message, EntityPlayer player)
		{
			if (player != null)
			{
